...
const team = [
  { name: "İlayda Coşar", role: "Engineering Student", initials: "IC" },
  { name: "Elvin Çalıklı", role: "Engineering Student", initials: "EC" },
  { name: "Ece Sude Gül", role: "Engineering Student", initials: "ESG" },
  { name: "Berk Kazankıran", role: "Engineering Student", initials: "BK" },
];
