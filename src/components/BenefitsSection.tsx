...
const benefits = [
  { icon: Clock, value: "40%", label: "Reduced Waiting Time", description: "Significantly shorter queues through optimized resource allocation." },
  ...
  { icon: Zap, value: "35%", label: "Better Service Efficiency", description: "Streamlined service flow increases throughput without extra resources." },
  { icon: Database, value: "100%", label: "Data-Driven Decisions", description: "Replace guesswork with mathematical models for capacity decisions." },
];
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-4">Measurable Impact on Service Operations</h2>
        </div>
